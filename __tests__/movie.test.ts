...
describe("GET / REQUESTS", () => {
  ...
  test("GET /?genres=action should return 200 and body length > 0 with action genre", async () => {
    const genre = "Action";
  ...
  test("GET /?duration=92&genres=action should return 200 and body length > 0 with action genre and movies with runtime+-10", async () => {
    const dur = 92;
    const genre = "Action";
